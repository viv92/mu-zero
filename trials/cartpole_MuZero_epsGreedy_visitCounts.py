...
plt.savefig('cartpole_MuZero_epsGreedyVisitCounts_epsDecay='+str(eps_decay_step)+'_lr='+str(lr)+'_planIter='+str(planning_iterations)+'_trainIter='+str(training_iterations)+'_numEP='+str(num_episodes)+'.png')
