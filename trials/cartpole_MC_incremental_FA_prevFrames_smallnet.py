...
plt.savefig('cartpole_MC_incremental_smallnet_prevFrames='+str(num_prev_frames)+'_epsDecay='+str(eps_decay_step)+'_lr='+str(lr)+'_numEP='+str(num_episodes)+'.png')
