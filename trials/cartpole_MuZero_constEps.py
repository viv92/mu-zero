...
plt.savefig('cartpole_MuZero_ucb_repBufSize='+str(rep_buf_size)+'_constEps='+str(eps)+'_lr='+str(lr)+'_planIter='+str(planning_iterations)+'_trainIter='+str(training_iterations)+'_numEP='+str(num_episodes)+'.png')
