...
plt.savefig('cartpole_qlearning_prevFrames='+str(num_prev_frames)+'_repBufSize='+str(rep_buf_size)+'_trainIters='+str(train_iters)+'_epsDecay='+str(eps_decay_step)+'_lr='+str(lr)+'_numEP='+str(num_episodes)+'.png')
